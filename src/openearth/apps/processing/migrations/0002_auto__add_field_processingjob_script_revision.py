...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessingJob.script_revision'
        db.add_column(u'processing_processingjob', 'script_revision',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessingJob.script_revision'
        db.delete_column(u'processing_processingjob', 'script_revision')
    ...
    models = {
        ...
        u'processing.processingjob': {
            ...
            'script_revision': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
