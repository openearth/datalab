...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessingJob.open_earth_revision'
        db.add_column(u'processing_processingjob', 'open_earth_revision',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessingJob.open_earth_revision'
        db.delete_column(u'processing_processingjob', 'open_earth_revision')
    ...
    models = {
        ...
        u'processing.processingjob': {
            ...
            'open_earth_revision': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
