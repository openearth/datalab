...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessingJob.revision'
        db.add_column(u'processing_processingjob', 'revision',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessingJob.revision'
        db.delete_column(u'processing_processingjob', 'revision')
